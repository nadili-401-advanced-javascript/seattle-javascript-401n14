...
![Singly Linked List](images/stack1.PNG){:target="_blank"} 
...
![Singly Linked List](images/pushStack3.PNG){:target="_blank"} 
...
![Singly Linked List](images/popStack1.PNG){:target="_blank"} 
