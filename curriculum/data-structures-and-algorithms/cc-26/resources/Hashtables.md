...
2. _Buckets_ - A bucket is what is contained in each index of the array of the hashtable. Each indicie is a bucket. An indicie could potentially contain multiple key/value pairs if a collision occurs.
...
A hashtable traditionally is created from an array. I always like the size 1024. _this is important for index placement_.
